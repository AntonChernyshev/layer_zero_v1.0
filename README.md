...
***Код открытый, проверяйте сами весь код, никакие ключи никуда не отправляются, но если ваши средства уйдут куда-то не туда, ответственность по использованию скрипта только на вас*** 
------------------------------------------------
Если код вам пригодился, будем рады вашему донату в любую EVM-сетку: 0x9d9D67FAF623a2D78A1eaa07579b7128fCD79dd9
------------------------------------------------
## Что умеет скрипт:
